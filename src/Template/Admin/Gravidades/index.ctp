 ...
 * @var \App\Model\Entity\Gravidade[]|\Cake\Collection\CollectionInterface $gravidades
 */
?>
...
<div class="gravidades index large-9 medium-8 columns content">
    <h3><?= __('Gravidades') ?></h3>
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                <th scope="col"><?= $this->Paginator->sort('id') ?></th>
                <th scope="col"><?= $this->Paginator->sort('gravidade') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $gravidade->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $gravidade->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $gravidade->id], ['confirm' => __('Are you sure you want to delete # {0}?', $gravidade->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
